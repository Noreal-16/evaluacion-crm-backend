    ...
    "status_code": 500
        ...
        <table>
            ...
            <tr>
                ...
                <td>string</td>
                <td>required</td>
                <td>Apellidos del cliente, puede ir en blanco cuando el tipo de identificación es Persona Jurídica.</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>numeric</td>
                <td>optional</td>
                <td>Interesado en Renovación 1(SI), 0(NO)</td>
            </tr>
            <tr>
...
print_r(json_decode((string) $body));</code></pre>
    ...
    "status_code": 500
        ...
        <h1>Pares</h1>
        <p>Api para Obtener los pares de un arreglo</p>
        <!-- START_00dbeb8940289d032b92cdc45e9b945e -->
        <h2>Obtiene todas las operaciones realizadas con los pares</h2>
        <blockquote>
            <p>Example request:</p>
        </blockquote>
        <pre><code class="language-bash">curl -X GET \
    -G "http://api-sugarcrm.casabaca.com/api/pares" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"medio":"11"}'
        ...
        <pre><code class="language-javascript">const url = new URL(
    "http://api-sugarcrm.casabaca.com/api/pares"
);
...
print_r(json_decode((string) $body));</code></pre>
    ...
    "status_code": 400
        ...
        <table>
            ...
            <tbody>
            <tr>
                <td><code>objetive</code></td>
                <td>numeric</td>
                <td>required</td>
                <td>Objetive requerido</td>
            </tr>
            <tr>
                <td><code>arrays</code></td>
                <td>string</td>
                <td>required</td>
                <td>Arrays requerido</td>
            </tr>
            </tbody>
        </table>
        <h2>Registra los valores de la matriz, objetive y el resultado de pares </h2>
        <blockquote>
            <p>Example request:</p>
        </blockquote>
        <pre><code class="language-bash">curl -X POST \
    ...
    "message": "Bad request"
        ...
        <table>
            ...
            <tr>
                ...
                <td>number</td>
                <td>required</td>
                <td>El objetivo del arreglo.</td>
            </tr>
            <tr>
                <td><code>arrays</code></td>
                <td>string</td>
                <td>required</td>
                <td>El tamaño del arreglo.</td>
            </tr>
